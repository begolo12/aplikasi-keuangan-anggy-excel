      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
        <Card className="overflow-hidden">
          ...
          <div className="p-5 space-y-4 text-xs">
            <div>
              <p className="text-[11px] font-semibold tracking-widest text-text-muted uppercase mb-2">Uang Tunai di 3 Kas</p>
            ...
            <div>
              <p className="text-[11px] font-semibold tracking-widest text-text-muted uppercase mb-2">Uang Dipinjamkan ke Orang Lain</p>
            ...
            <div>
              <p className="text-[11px] font-semibold tracking-widest text-text-muted uppercase mb-2">Barang Berharga</p>
              <div className="space-y-1.5 pl-2">
          ...
          <div className="p-4 bg-canvas border-t border-border flex items-center justify-between font-bold text-sm text-text">
            <span>TOTAL HARTA</span><span className="num text-positive">Rp {formatRibuan(totalAktiva)}</span>
          </div>
        </Card>

        <Card className="overflow-hidden">
          <div className="p-4 bg-accent-hover text-white flex items-center justify-between">
          ...
          <div className="p-5 space-y-4 text-xs">
            <div>
              <p className="text-[11px] font-semibold tracking-widest text-text-muted uppercase mb-2">Hutang & Cicilan</p>
            ...
            <div>
              <p className="text-[11px] font-semibold tracking-widest text-text-muted uppercase mb-2">Kekayaan Bersih</p>
          ...
          <div className="p-4 bg-canvas border-t border-border flex items-center justify-between font-bold text-sm text-text">
            <span>TOTAL HUTANG + KEKAYAAN</span><span className="num text-positive">Rp {formatRibuan(totalPassiva)}</span>
          </div>
        </Card>
      </div>
    </div>
